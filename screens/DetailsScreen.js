...
export default function DetailScreen({ route }) {
  ...
  useEffect(() => {
    const fetchDetails = async () => {
      setLoading(true);
      try {
        const fields = 'id,title,image_id,date_start,artist_title,medium_display,dimensions,thumbnail,credit_line';
  ...
  return (
    <ScrollView contentContainerStyle={styles.container} maximumZoomScale={3} minimumZoomScale={1}>
